...
/**
 * Custom character splitter (replaces premium GSAP SplitText).
 * Wraps each character in a span for animation targeting.
 */
...
const Shuffle = ({
  ...
  useEffect(() => {
    ...
    const build = () => {
      ...
      // Use custom character splitter instead of premium SplitText
      splitRef.current = splitIntoChars(el);
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    respectReducedMotion, triggerOnHover
  ]);
